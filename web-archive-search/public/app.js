...
const LANGS = {
  en: {
    ...
    how2text: 'Simultaneously query Wayback Machine, LoC, UK Web Archive and Arquivo.pt',
  ...
  uk: {
    ...
    how2text: 'Одночасно запитуємо Wayback Machine, LoC, UK Web Archive та Arquivo.pt',
    ...
    archiveSub4: 'Британська бібліотека',
  ...
  ru: {
    ...
    how2text: 'Одновременно запрашиваем Wayback Machine, LoC, UK Web Archive и Arquivo.pt',
    ...
    archiveSub4: 'Британская библиотека',
