...
// .wrangler/tmp/bundle-hpzffr/checked-fetch.js
...
// .wrangler/tmp/pages-VtihEU/functionsWorker-0.5074298630954575.mjs
...
async function onRequestGet(context) {
  ...
  const [waybackRes, ptRes] = await Promise.allSettled([
    ...
    withTimeout(fetchArquivoPt(cleanUrl), 8e3)
  ]);
...
async function fetchAvailability(url) {
  ...
  __name(tryOne, "tryOne");
  __name2(tryOne, "tryOne");
...
__name(fetchArquivoPt, "fetchArquivoPt");
__name2(fetchArquivoPt, "fetchArquivoPt");
...
// .wrangler/tmp/bundle-hpzffr/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-hpzffr/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.5074298630954575.js.map
